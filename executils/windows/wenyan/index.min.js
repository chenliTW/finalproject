...
var hanzi2pinyin_1 = __webpack_require__(22);
exports.hanzi2pinyin = hanzi2pinyin_1.hanzi2pinyin;
var reader_1 = __webpack_require__(8);
var macro_1 = __webpack_require__(25);
var version_1 = __webpack_require__(7);
exports.version = version_1.version;
var keywords_1 = __webpack_require__(9);
exports.NUMBER_KEYWORDS = keywords_1.NUMBER_KEYWORDS;
exports.KEYWORDS = keywords_1.KEYWORDS;
var stdlib_1 = __webpack_require__(26);
exports.STDLIB = stdlib_1.STDLIB;
var typecheck_1 = __webpack_require__(44);
var transpilers_1 = __importDefault(__webpack_require__(46));
var utils_1 = __webpack_require__(5);
var execute_1 = __webpack_require__(10);
...
var _this = this;
Object.defineProperty(exports, "__esModule", { value: true });
var fs_1 = __importDefault(__webpack_require__(0));
var path_1 = __importDefault(__webpack_require__(1));
var commander_1 = __importDefault(__webpack_require__(12));
var find_up_1 = __importDefault(__webpack_require__(15));
var version_1 = __webpack_require__(7);
var parser_1 = __webpack_require__(3);
...
var inpHistoryPtr = -1;
var Logo = " ,_ ,_\n \\/ ==\n /\\ []\n";
var MODULE_LIBRARY_NAME = "藏書樓";
var program = new commander_1.default.Command();
program
    .version(version_1.version, "-v, --version", "Output the version")
    .name("wenyan")
    .arguments("[files...]")
    ...
    .option("-l, --lang <lang>", 'Target language, can be "js", "py" or "rb"', "js")
    ...
    .option("-o, --output [file]", "Output compiled code or executing result to file")
    .option("-r, --render", "Outputs renderings")
    .option("--roman [method]", 'Romanize identifiers. The method can be "pinyin", "baxter" or "unicode"')
...
var emptyCall = process.argv.length <= 2;
var showHelp = process.argv.includes("-h") || process.argv.includes("--help");
if (emptyCall || showHelp) {
    program.outputHelp(function (help) {
        ...
        var text = "\n";
        text += Logo;
        text += "\nWENYAN LANG \u6587\u8A00 Compiler v" + version_1.version + "\n\n";
        text += help;
        text += "\n";
        return text;
    });
...
(function () { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                preprocess();
                if (!program.compile) return [3 /*break*/, 1];
                output(getCompiled());
                return [3 /*break*/, 6];
            case 1:
                if (!program.render) return [3 /*break*/, 2];
                doRender();
                return [3 /*break*/, 6];
            case 2:
                if (!program.interactive) return [3 /*break*/, 4];
                return [4 /*yield*/, interactive()];
            case 3:
                _a.sent();
                return [3 /*break*/, 6];
            case 4: return [4 /*yield*/, exec()];
            case 5:
                _a.sent();
                _a.label = 6;
...
function preprocess() {
    ...
    if (program.output == true) {
        ...
        var base = program.files[0]
            .split(".")
            .slice(0, -1)
            .join(".");
        if (program.compile)
            program.output = base + "." + program.lang;
        else if (program.render)
            program.output = base + ".svg";
        else
            program.output = base + ".log";
    }
...
function getCompiled() {
    ...
    return parser_1.compile(source, __assign({}, getCompileOptions()));
}
function getImportPaths() {
    var pathes = [];
    if (program.dir) {
        pathes.push.apply(pathes, program.dir.split(","));
    }
    var moduleLib = findModuleLibrary();
    if (moduleLib)
        pathes.push(moduleLib);
    pathes.push.apply(pathes, program.files.map(function (file) { return path_1.default.resolve(path_1.default.dirname(file)); }));
    pathes.push(path_1.default.resolve("."));
    return Array.from(new Set(pathes));
}
function findModuleLibrary() {
    return find_up_1.default.sync(MODULE_LIBRARY_NAME, { type: "directory" });
}
...
function getSource() {
    var scripts = program.files
        .map(function (x) {
        return x.endsWith(".svg")
            ? render_1.unrender([fs_1.default.readFileSync(resolvePath(x)).toString()])
            : fs_1.default.readFileSync(resolvePath(x)).toString();
    })
        .join("\n");
    if (program.eval)
        scripts += "\n" + program.eval;
...
function output(data) {
    if (program.output == undefined)
        ...
        fs_1.default.writeFileSync(resolvePath(program.output), data, "utf-8");
}
function getTitle() {
...
function doRender() {
    var svgs = render_1.render(getTitle(), getSource(), { plotResult: false });
    ...
    if (svgs.length === 1) {
        ...
        fs_1.default.writeFileSync(filepath, svgs[0]);
        console.log(filepath); // Outputs generated filename
    }
    // multiple pages rendered, output file as `filename.001.svg` etc
    else {
        if (outputEndsWithSvg)
            program.output = program.output.slice(0, -4); // remove .svg suffix
        for (var i = 0; i < svgs.length; i++) {
            var filepath = resolvePath(program.output + "." + i.toString().padStart(3, "0") + ".svg");
            fs_1.default.writeFileSync(filepath, svgs[i]);
            console.log(filepath); // Outputs generated filename
        }
    }
}
function interactive() {
    if (program.lang !== "js") {
        console.error("Target language \"" + program.lang + "\" is not supported for interactive mode.");
        process.exit(1);
    }
    replscope();
    repl(getCompiled());
...
function exec() {
    if (program.lang !== "js") {
        console.error("Target language \"" + program.lang + "\" is not supported for direct executing. Please use --compile option instead.");
        process.exit(1);
    }
    parser_1.evalCompiled(getCompiled(), {
...
function repl(prescript) {
    if (!readline) {
        readline = __webpack_require__(52);
    ...
    if (prescript) {
        ...
        try {
            console.log = execute_1.outputHanziWrapper(console.log, program.outputHanzi);
            // @ts-ignore
...
function logHandler(f, mode) {
    ...
    if (mode == "a") {
        return function (x) {
            fs_1.default.appendFileSync(resolvePath(f), (typeof x == "object" ? JSON.stringify(x) : x.toString()) + "\n");
        };
    }
    if (mode == "w") {
        return function (x) {
            fs_1.default.writeFileSync(resolvePath(f), (typeof x == "object" ? JSON.stringify(x) : x.toString()) + "\n");
        };
    }
}
...
__webpack_require__(2).inherits(Command, EventEmitter);
...
const locatePath = __webpack_require__(16);
...
const pLocate = __webpack_require__(17);
...
const pLimit = __webpack_require__(18);
...
const pTry = __webpack_require__(19);
...
Object.defineProperty(exports, "__esModule", { value: true });
var hanzi2roman_map_pinyin_json_1 = __importDefault(__webpack_require__(23));
var hanzi2roman_map_baxter_json_1 = __importDefault(__webpack_require__(24));
...
function loadStdlib() {
    var STDLIB = {};
    try {
        var raw_1 = __webpack_require__(27);
...
Object.defineProperty(exports, "__esModule", { value: true });
var js_1 = __importDefault(__webpack_require__(47));
var py_1 = __importDefault(__webpack_require__(48));
var rb_1 = __importDefault(__webpack_require__(49));
var transpilers = {
    js: js_1.default,
    py: py_1.default,
    rb: rb_1.default
...
Object.defineProperty(exports, "__esModule", { value: true });
var highlight_1 = __webpack_require__(51);
var hanzi2num_1 = __webpack_require__(4);
var parser_1 = __webpack_require__(3);
...
var { num2hanzi } = __webpack_require__(4);
var { NUMBER_KEYWORDS, KEYWORDS } = __webpack_require__(9);
